...
const TrackButton = styled(RubberButton)<{ $active: boolean }>`
  ...
  height: 35px;
  font-size: 0.7rem;
  background-color: ${(props) => (props.$active ? "#00ff00" : "#444")};
  color: ${(props) => (props.$active ? "#000" : "#aaa")};
  box-shadow: ${(props) => (props.$active ? "0 0 5px #00ff00, inset 0 1px 1px rgba(255,255,255,0.5)" : "inset 0 1px 1px rgba(255,255,255,0.1), 0 2px 2px rgba(0,0,0,0.5)")};
  border: 1px solid ${(props) => (props.$active ? "#00cc00" : "#222")};

  &:active {
    background-color: ${(props) => (props.$active ? "#00cc00" : "#333")};
